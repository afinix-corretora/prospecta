-- Reverte para a versão do D39: com o portão de supressão, sem os portões de
-- encerramento, pausa e campanha desligada. Nota: é a versão que manda mais
-- um toque para quem acabou de responder.
